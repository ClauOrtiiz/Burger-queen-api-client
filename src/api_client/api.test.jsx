...
describe('Api', () => {
    ...
    describe('Función login', () => {
        test('should log in with correct credentials', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('https://mock-burgerqueen.onrender.com/login', {
                method: 'POST',
                headers: {
    ...
    describe('Función fetchProducts', () => {
        test('should fetch products with a valid token//debe buscar productos con un token válido', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('https://mock-burgerqueen.onrender.com/products', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
    ...
    describe('Función fetchSendOrder', () => {
        ...
        test('enviar orden exitosamente', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith('https://mock-burgerqueen.onrender.com/orders', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    Authorization: `Bearer ${token}`,
    ...
    describe('Función fetchGetOrder', () => {
        test('Deberia mostrar la lista de pedidos', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('https://mock-burgerqueen.onrender.com/orders', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    describe('Función changeStatus', () => {
        ...
        test('Deberia modificar el estado de la orden', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('https://mock-burgerqueen.onrender.com/orders/1', {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    describe('fetchShowUsers', () => {
        test('debería devolver los usuarios filtrados por rol si la respuesta es exitosa', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('https://mock-burgerqueen.onrender.com/users', {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    describe('Función fetchCreateProduct ', () => {
        test('Debe crear un producto', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(
                'https://mock-burgerqueen.onrender.com/products',
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    describe('Función fetchCreateStaff ', () => {
        test('Debe crear un usuario', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(
                'https://mock-burgerqueen.onrender.com/users',
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    describe('Función fetchEditProducts ', () => {
        ...
        test('Debe Editar a un producto especifico', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(
                `https://mock-burgerqueen.onrender.com/products/${product.id}`,
                {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    describe('Función fetchEditStaff', () => {
        ...
        test('Debe Editar a un personal especifico', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(
                `https://mock-burgerqueen.onrender.com/users/${user.id}`,
                {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
    ...
    describe('Función fetchDeleteProduct', () => {
        ...
        test('Debe eliminar el producto especificado', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(
                `https://mock-burgerqueen.onrender.com/products/${productId}`,
                {
                    method: 'DELETE',
                    headers: {
                        'Authorization': `Bearer ${token}`
